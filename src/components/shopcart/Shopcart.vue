        ...
        <div class="shopcart-wrapper">
            ...
            <div class="content-left">
                ...
                <div class="desc-wrapper">
                    ...
                    <p class="tip" v-show="totalPrice" :class="{'highligh':totalCount>0}">
    ...
    export default {
        ...
        computed: {
            ...
            totalPrice() {
                let total = 0;
                this.selectFoods.forEach((food) => {
                    total += food.min_price * food.count    //总价钱
                });
                // console.log(total)
                return total
            },
            ...
            listShow() {
                if (!this.totalCount) {//购物车为0时
                    this.fold = true;   //不展示列表
                    return false
                }
                let show = !this.fold;
                if (show) {
                    this.$nextTick(() => {
                        if (!this.shopScroll) {
                            this.shopScroll = new BScroll(this.$refs.listContent, { //实现滚动
                                click: true
                            })
                        } else {
