            ...
            <div class="content">
                <div class="rating-select" v-if="ratings.tab">
                    ...
                    <span class="item" :class="{'active':selectType===0}" @click="selectTypeFn(0)">
                        <img v-show="selectType!==0" src="./img/icon_sub_tab_dp_normal@2x.png" alt="">
                        <img v-show="selectType===0" src="./img/icon_sub_tab_dp_highlighted@2x.png" alt="">
                        {{ratings.tab[2].comment_score_title}}
                    </span>
                </div>
                <div class="labels-view">
                    <span class="item" :class="{'heigligh':item.label_star>0}" v-for="(item,index) in ratings.labels"
                          :key="index">
